...
run_prcc_populationgrowth <- function(abx.r) {
  ...
  parameters <- list(
    ...
    r_thres = c("qunif", list(min = 0.01, max = 0.15)),       # r_thres = threshold amount of bacteria before R can be transmitted
...
run_prcc_populationgrowth(0.5) 
run_prcc_populationgrowth(0.00001) 
