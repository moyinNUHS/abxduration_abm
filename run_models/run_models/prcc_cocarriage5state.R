...
parameters <- list(
    ...
    fitness.r = c("qunif", list(min=0, max=2)),      #fitness cost of R growth when not on antibiotics 
    ...
    abx.r = c("qunif", list(min=0, max=0.00000001)),      #probability of clearing R to become r
